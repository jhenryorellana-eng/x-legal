...
export const homeMock: DashboardScreenProps = {
  ...
  cases: [
    ...
    {
      caseId: "demo4",
      href: "/caso/demo4/camino",
      title: "Taxes 2024 — María",
      phaseLabel: "En revisión por tu contador",
      serviceIcon: "doc",
      serviceColor: "#F0A500",
      progress: 100,
      pendingDocuments: 0,
  ...
  onboardingCases: [
    {
      caseId: "demo2",
      title: "Taxes 2025 — María",
      serviceIcon: "doc",
      serviceColor: "#F0A500",
      step: "sign",
      signHref: "/firma/demo-token",
    },
  ],
  labels: {
    ...
    payNow: "Pagar ahora",
    activateTitle: "Activa tu caso",
    stepSign: "Firma tu contrato",
    stepPay: "Paga tu primera cuota",
    signCta: "Firmar",
    stepDoneLabel: "Hecho",
    stepLaterLabel: "Después",
    preparingLabel: "Preparando tu contrato",
    lockedLabel: "Tu caso se activa al completar estos pasos",
