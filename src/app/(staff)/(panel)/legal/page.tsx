 ...
 *   2. listCasesForParalegal(actor) → only Diana's assigned cases.
...
export default async function LegalPage() {
  ...
  // 1. listCasesForParalegal → only Diana's assigned cases (GAP-1).
  ...
  try {
    myCases = await listCasesForParalegal(actor);
