...
import {
  ...
  deleteGroupUi,
  upsertQuestionUi,
  updateQuestionAiImproveUi,
  deleteQuestionUi,
  generateTestPdfUi,
  publishVersionUi,
  unpublishVersionUi,
  duplicateVersionUi,
  setVersionEmptyPolicyUi,
  updateGenerationConfigUi,
  saveQuestionnaireGenConfigUi,
  savePreMortemGuideUi,
  testGenerationUi,
...
export default async function FormEditorPage({
  ...
  const actions: FormEditorActions = {
    ...
    updateQuestionAiImprove: updateQuestionAiImproveUi,
    ...
    setVersionEmptyPolicy: setVersionEmptyPolicyUi,
    saveGenerationConfig: updateGenerationConfigUi,
    saveQuestionnaireGenConfig: saveQuestionnaireGenConfigUi,
    savePreMortemGuide: savePreMortemGuideUi,
