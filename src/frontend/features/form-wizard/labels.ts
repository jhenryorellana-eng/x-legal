...
export function resolveWizardLabels(t: (key: string) => string): WizardLabels {
  ...
  return {
    ...
    improveIdle: t("improveIdle"),
    improveLoading: t("improveLoading"),
    improveUndo: t("improveUndo"),
    improveError: t("improveError"),
    researchSearchLabel: t("researchSearchLabel"),
    researchResultLabel: t("researchResultLabel"),
    researchPlaceholder: t("researchPlaceholder"),
    researchButton: t("researchButton"),
    researchLoading: t("researchLoading"),
    researchError: t("researchError"),
    researchEmptyResult: t("researchEmptyResult"),
    researchSources: t("researchSources"),
    researchManualEdit: t("researchManualEdit"),
    researchLockResult: t("researchLockResult"),
