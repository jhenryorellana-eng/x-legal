...
/** GeneracionesTab — the credible-fear memo (disruptive AI-core loader on Generar). */
export function GeneracionesTab({ scenario, flow }: { scenario: DemoScenario; flow: StaffFlow }) {
