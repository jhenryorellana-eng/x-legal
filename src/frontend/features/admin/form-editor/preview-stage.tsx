...
function previewLabels(lang: "es" | "en"): WizardLabels {
  ...
  return {
    ...
    improveIdle: t("Mejorar con IA", "Improve with AI"),
    improveLoading: t("Mejorando…", "Improving…"),
    improveUndo: t("Deshacer", "Undo"),
    improveError: t("No se pudo mejorar. Tu texto sigue igual.", "We couldn't improve it. Your text is unchanged."),
    researchSearchLabel: t("Buscar dirección", "Search address"),
    researchResultLabel: t("Resultado de la búsqueda", "Search result"),
    researchPlaceholder: t("Pega aquí la dirección del tribunal y presiona Buscar…", "Paste the court address here and press Search…"),
    researchButton: t("Buscar", "Search"),
    researchLoading: t("Buscando…", "Searching…"),
    researchError: t("No se pudo completar la búsqueda. Inténtalo de nuevo.", "The search couldn't be completed. Please try again."),
    researchEmptyResult: t("El resultado de la búsqueda aparecerá aquí.", "The search result will appear here."),
    researchSources: t("Fuentes", "Sources"),
    researchManualEdit: t("Corregir a mano", "Edit manually"),
    researchLockResult: t("Volver al resultado de la IA", "Back to the AI result"),
    ...
    reviewClientEditBanner: t(
      "Estás llenando este formulario en nombre del cliente. Los cambios se guardan solos.",
      "You're filling in this form on behalf of the client. Changes save automatically.",
    ),
