...
export function buildCatalogStrings(tt: Translator): Record<string, string> {
  const keys = [
    ...
    "translationStepTitle", "translationStepSub", "translationStepNote",
    "translationSignerName", "translationSignerNamePh", "translationSignatureImage",
    "translationDrop", "translationUploading", "translationImageHint",
    "translationImageType", "translationImageUploaded", "translationSaveServiceFirst",
    "contractStepTitle", "contractStepSub", "contractStepNote",
    "contractObject", "contractScope", "contractScopeHint", "contractSpecial",
    "expedienteStepTitle", "expedienteStepSub", "expedienteStepNote",
    "expedienteGuidanceLabel", "expedienteGuidancePh", "expedienteSaveServiceFirst",
    ...
    "partyRequired", "partyInContract", "partyRemove", "partyNeedLabel", "partyDup", "partyApplicantFixed",
    ...
    "deadlineTitle", "deadlineSub", "deadlineEnabled", "deadlineAnchorLabel",
    "deadlineDaysLabel", "deadlineMinBiz", "deadlineMailBuffer",
    "deadlineAnchoredStage", "deadlineStageNone", "deadlineNoSlaWarn", "deadlineSave",
    "externalToolTitle", "externalToolSub", "externalToolEnabled", "externalToolBaseUrl",
    "externalToolBaseUrlHelp", "externalToolAttempts", "externalToolAttemptsHelp",
    "externalToolInstructions", "externalToolSave", "externalToolError",
    ...
    "docSchemaValid", "docSchemaEmpty", "docSchemaRequired", "docSchemaMapHint",
    "docSchemaSave", "docSchemaCancel",
    "formPdf", "formAi", "filledBy", "filledClient",
