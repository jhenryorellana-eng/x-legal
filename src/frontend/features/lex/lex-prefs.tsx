 ...
 *
 * "Burbujas proactivas de Lex" master switch, persisted in localStorage. Mounted
 * once at the staff panel layout so the toggle governs the bubbles in ALL four
 * panels (admin · sales · legal · finance). The provider hydrates from storage;
 * the config toggle flips it and every LexBubble reads `enabled` from here.
 * Defaults ON.
 */
