/**
 * Mints a Vanessa (sales) Supabase session and prints the SSR auth cookie
 * ({name, value}) as JSON — for Playwright addCookies on localhost.
 * Usage: node docs/_evidence/mint-vanessa.cjs
 */
const fs = require("fs");
