/* Mint an Ivis Palma client session (U26-000038) for the ola4 client-platform walk.
 * Sets her password (service role, idempotent), signs in, writes the @supabase/ssr
 * cookie value + name. */
const fs = require("fs");
